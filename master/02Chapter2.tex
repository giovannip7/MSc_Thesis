...
As far as robots are concerned, a wide variety of sensors can be applied to your model: stereo camera, RGB camera, tracking, contact sensors. It is also possible to add the noise model to the sensors.
